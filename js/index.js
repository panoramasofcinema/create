...
function doModal(element) {
    ...
    if (which == 'infoBtn'){
        ...
        "<p>Panorama🎛App creates panoramic views of images from <a href='https://paradiso.panoramasofcinema.ch' target='_blank'>Paradis🍅</a>—a collection of movies in love with architecture. "+
        "These views show with examples found in movie frames, how an idea, a mood, or a space-to-be looks. "+
        "By implementing Machine Learning techniques, Panorama🎛App arranges hundreds of images in a navigable space where similarities and rarities are easily recognized. "+
        "To create your own panorama, visit <a href='https://panoramasofcinema.ch' target='_blank'>Panoramas of Cinema🍿</a> and tag the images you want to include in your view.</p>"+
        "<p>Panorama🎛App is developed by <a href='https://www.digitalpentecost.online' target='_blank'>Dr.Sc. Jorge Orozco</a> at the <a href='https://www.caad.arch.ethz.ch' target='_blank'>Chair for Digital Architectonics</a> in ETHZ's Department of Architecture.</p>"
    }
}
